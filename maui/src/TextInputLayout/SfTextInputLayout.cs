...
namespace Syncfusion.Maui.Toolkit.TextInputLayout
{
    ...
    public partial class SfTextInputLayout : SfContentView, ITouchListener, IParentThemeElement
    {
        ...
        /// </summary>
        double _translateStartY = 0;

        /// <summary>
        /// Gets or sets the vertical end value for custom animation.
        /// </summary>
        double _translateEndY = 1;

		/// <summary>
		/// Gets or sets the horizontal start value for custom animation.
		/// </summary>
		double _translateStartX = 0;

		/// <summary>
		/// Gets or sets the horizontal end value for custom animation.
		/// </summary>
		double _translateEndX = 1;
